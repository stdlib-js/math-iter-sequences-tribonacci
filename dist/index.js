...
var P=require('@stdlib/assert-is-plain-object/dist'),T=require('@stdlib/assert-has-own-property/dist'),j=require('@stdlib/assert-is-nonnegative-integer/dist').isPrimitive,f=require('@stdlib/error-tools-fmtprodmsg/dist');function N(i,r){if(!P(r))return new TypeError(f('null2V',r));if(T(r,"iter")){if(i.iter=r.iter,!j(r.iter))return new TypeError(f('null2t',"iter",r.iter));if(r.iter>64)return new RangeError(f("invalid option. `%s` option must be less than or equal to 64. Option: `%u`.","iter",r.iter))}return null}d.exports=N
